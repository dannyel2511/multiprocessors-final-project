...
class MainDecipher {
   ...
   public static void main(String args[]) {
      ...
      if(args.length < 2) {
         System.out.println("You must provide the name, route and extension of the file to be deciphered as well as the name for output\n");
         System.out.println("Example: ./decryp files/test.aes files/test.jpg\n");
         return;
      }
      ...
      for(int j = 0; j < 10; j++) {                      // Execute 10 times to measure properly the runtime
         ad = new AES_decipher(file_in, key);            // Instantiate the object to decipher
      ...
      System.out.println("Decryption process finished. Avg time = "+time_taken/10.0);

      file_out = ad.get_file_out();                      // Get the file ciphered
